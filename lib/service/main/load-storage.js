...
var _carrier = require('../../state/carrier');
...
exports.default = (() => {
  var _ref = _asyncToGenerator(function* (dcMap, uid) {
    ...
    for (var _iterator = dcMap.keys(), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
      ...
      var dcInt = (0, _carrier.toDCInt)(_dc);
      var inactive = true;
      var fields = {
        authKey: [],
        salt: [],
      ...
      if (Array.isArray(salt)) {
        ...
        authList = Object.assign({}, authList, {
      ...
      if (!inactive) networker = Object.assign({}, networker, {
    ...
    if (nearest !== false) {
      iHome = nearest;
      flags = Object.assign({}, flags, { homeDC: true
